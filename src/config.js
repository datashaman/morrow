...
export const FIRMS = [
  { name: "Harvest Foods", sector: "food", sells: "budgetFood", input: "produce", source: "Morrow Fields", production: "sourced", sourceDescription: "retail staff turn farm produce into everyday meals", x: 0.17, y: 0.28, price: 1.8, quality: 0.55, wage: 6.2, productivity: 0, transactionsPerWorker: 8, inventory: 22, initialStaff: 3, maxStaff: 6 },
  ...
  { name: "HomeWorks", sector: "housing", sells: "housing", input: null, source: null, production: "fixed-service", sourceDescription: "housing staff operate the town's current dwelling service", x: 0.80, y: 0.29, price: 6, wage: 7.2, productivity: 0, transactionsPerWorker: 10, inventory: 0, initialStaff: 4, maxStaff: 6 },
  ...
  { name: "Morrow Fields", sector: "agriculture", sells: "produce", input: null, source: null, production: "direct", sourceDescription: "farm workers grow produce locally", x: 0.08, y: 0.68, price: 1.1, wage: 5.8, productivity: 9, transactionsPerWorker: 8, inventory: 36, initialStaff: 7, maxStaff: 12 },
];
