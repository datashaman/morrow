...
test("Morrow starts with an essential four-firm foundation and six visible opportunities", () => {
  ...
  assert.deepEqual(town.firmOpportunities().map((opportunity) => opportunity.name), ["Common Café", "Green Basket", "Morrow Apothecary", "Morrow School", "Morrow Materials", "Morrow Clinic"]);
