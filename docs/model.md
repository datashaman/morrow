...
#### Private café, premium-food, apothecary, school, and materials formation

Endogenous private formation applies when the Common Café, Green Basket, Morrow Apothecary, Morrow School, or Morrow Materials archetype is absent at initialization. An absent archetype remains off the map and appears in the firm panel as an opportunity rather than an operating firm.
