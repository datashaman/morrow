...
- Food retailers, the café, apothecary, materials yard, and builder use one-to-one abstract conversions with no waste, recipes, grades, energy, equipment, storage cost, or processing delay. The materials yard treats one Makers Guild kit as enough fabricated input for one construction bundle, and the builder treats one bundle as one project; this is explicit accounting but not a realistic bill of materials. Agriculture itself consumes no seed, land, water, fertilizer, energy, maintenance, or capital.
...
- Supply and haulage settle immediately and exactly in cash at fixed quantities; prices inherit the supplier's proportional owner adjustment. There is no bilateral negotiation, expiry, alternate supplier, trade credit, invoice, debt, title document, insurance, or damages for under-delivery.
...
- Harvest Foods alone scales its two-day stock target and one-day procurement ceiling to the living population, up to a fixed 40-unit contract. This does not model measured consumption forecasts, safety stock, supplier lead time, seasonal demand, waste, or demographic nutrition needs.
