...
- Endogenous private formation is limited to the first Common Café instance in a town explicitly initialized without that firm. Its seven-day opportunity window, 50% demand capture, 8% margin buffer, 40 startup capital, protected ten-day founder runway, deterministic founder ranking, and immediate staffing/contracts are gameplay hypotheses. Other archetypes cannot yet form privately, and a failed café cannot yet attract a replacement entrant.
