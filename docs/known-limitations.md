...
- The paired employment evaluator is a deterministic falsification harness, not evidence that employment alone causes mortality or that the intervention is realistic, fair, or sufficient. It reports application, wage, support, hardship, business, and death trajectories so aggregate improvement cannot hide a failed mechanism or worsened seed.
