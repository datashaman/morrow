...
- The paired knowledge evaluator can falsify whether learning records and a gross grocery capacity contribution occur in fixed seeded runs, and it exposes floored capacity and town-outcome deltas. It does not calibrate the learning rates, prove the contribution changes a completed transaction, or establish that any observed survival, employment, hunger, housing, or insolvency difference was beneficial or realistic.
