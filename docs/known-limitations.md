...
Stress falls through financial runway, stable employment, food, housing, friendship strength, recent contact, a small immediate comfort purchase, and a bounded free-rest action. The apothecary restores health rather than stress. There is no distinct sleep schedule, clinical care, recovery from resolving arrears, predictable schedules, time safely housed, autonomy model, or longer treatment course.
...
- Food retailers, the café, apothecary, and materials yard use one-to-one abstract conversions with no waste, recipes, grades, energy, equipment, transport, storage cost, or handling delay. The materials yard treats one Makers Guild kit as enough fabricated input for one construction bundle; this is explicit accounting but not a realistic bill of materials. Agriculture itself consumes no seed, land, water, fertilizer, energy, maintenance, or capital.
...
- Endogenous private formation and replacement are limited to Common Café, Green Basket, Morrow Apothecary, Morrow School, and Morrow Materials. Their seven-day opportunity window, capture assumptions, 8% margin buffer, 40 startup capital, protected ten-day founder runway, deterministic founder ranking, 21-day post-failure cooldown, permanent exclusion of prior owners, and immediate staffing/contracts are gameplay hypotheses. Apothecary demand additionally uses an uncalibrated 68% health threshold and two-day post-purchase essential reserve; school demand uses a 72% skill threshold and three-day reserve; materials assumes one recurring HomeWorks bundle whenever housing operates. Other archetypes cannot form privately, and there is no reputation, lender confidence, incorporation, acquisition, asset sale, or variable startup plan.
- The interactive minimal start assumes one operating firm in each essential production, food, housing, and maintenance role. It does not model how those initial institutions were founded. Historical diagnostics explicitly restrict which newer latent archetypes may form, so evaluation results must identify their starting composition and formation set before being compared.
...
- Health setbacks remain generic random events with no diagnosis, duration, differentiated severity, contraindication, or condition-specific recovery. One exact apothecary dose costs 3.6 and adds a fixed 0.08 health up to 0.92; this is a gameplay recovery path, not a clinical model. There is no clinic, professional triage, insurance, prescription, inpatient care, or proof that a treatment matches a setback.
